...
if __name__ == '__main__':
    ...
    именами, находящиеся в директории testdata. Благодаря асинхронности можно добавлять огромные объемы данных очень 
    быстро, класс BitrixAPI принимает на вход ограничение количества одновременных запросов на добавления контактов, 
    можно увеличить или уменьшить в зависимости от ограничений API Bitrix24, по умолчанию 1000"""
